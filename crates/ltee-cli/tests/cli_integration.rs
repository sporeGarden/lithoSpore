...
// ── USB round-trip integration test ───────────────────────────────
...
#[test]
fn usb_roundtrip_assemble_then_verify() {
...
#[test]
fn usb_roundtrip_assemble_then_validate() {
    let source = build_source_repo();
    let assembled = tempfile::tempdir().expect("create assembly target");
...
#[test]
fn usb_roundtrip_symlinks_correct() {
    let source = build_source_repo();
    let assembled = tempfile::tempdir().expect("create assembly target");
...
#[test]
fn usb_roundtrip_biomeos_spore_generated() {
    let source = build_source_repo();
    let assembled = tempfile::tempdir().expect("create assembly target");
...
#[test]
fn usb_roundtrip_verify_detects_post_assembly_drift() {
    let source = build_source_repo();
    let assembled = tempfile::tempdir().expect("create assembly target");
    ...
    // Tamper with a data file after assembly (simulates USB corruption)
    let csv = assembled
        .path()
